        ...
        <div class="row">
                ...
                <div class="blog-box">
                    <div class="post-media">
                        <a href="marketing-single.html" title="">
                            <img src="{{ url('/public/front') }}/upload/market_blog_02.jpg" alt=""
                                class="img-fluid">
            ...
            <div class="col-lg-6">
                <div class="blog-box">
                    <div class="post-media">
                        <a href="marketing-single.html" title="">
                            <img src="{{ url('/public/front') }}/upload/market_blog_03.jpg" alt=""
                                class="img-fluid">
                            <div class="hovereffect">
                                <span class=""></span>
                            </div><!-- end hover -->
                ...
                <div class="comments-list">
                    <div class="media">
                        <a class="media-left" href="#">
                            <img src="{{ url('/public/front') }}/upload/author.jpg" alt=""
                    ...
                    <div class="media">
                        <a class="media-left" href="#">
                            <img src="{{ url('/public/front') }}/upload/author_01.jpg" alt=""
                                class="rounded-circle">
                        </a>
                        <div class="media-body">
                    ...
                    <div class="media last-child">
                        <a class="media-left" href="#">
                            <img src="{{ url('/public/front') }}/upload/author_02.jpg" alt=""
                                class="rounded-circle">
                        </a>
                        <div class="media-body">
