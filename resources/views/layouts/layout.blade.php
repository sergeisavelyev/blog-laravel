...
<link href="{{ url('/public/front') }}/css/bootstrap.css" rel="stylesheet">

<link href="{{ url('/public/front') }}/css/font-awesome.min.css" rel="stylesheet">
...
<link href="{{ url('/public/front') }}/css/colors.css" rel="stylesheet">

<link href="{{ url('/public/front') }}/css/version/marketing.css" rel="stylesheet">
...
<body>
            ...
            <div class="container-fluid">
                <nav class="navbar navbar-toggleable-md navbar-inverse fixed-top bg-inverse">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"><img
                            src="{{ url('/public/front') }}/images/version/market-logo.png" alt=""></a>
                                ...
                                <div class="list-group">
                                    <a href="marketing-single.html"
                                        ...
                                        <div class="w-100 justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_04.jpg" alt=""
                                    ...
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_05.jpg" alt=""
                                                class="img-fluid float-left">
                                    ...
                                    <a href="marketing-single.html"
                                        ...
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_06.jpg" alt=""
                                                class="img-fluid float-left">
                            ...
                            <div class="blog-list-widget">
                                <div class="list-group">
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_01.jpg" alt=""
                                                class="img-fluid float-left">
                                    ...
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_02.jpg" alt=""
                                                class="img-fluid float-left">
                                    ...
                                    <a href="marketing-single.html"
                                        class="list-group-item list-group-item-action flex-column align-items-start">
                                        <div class="w-100 last-item justify-content-between">
                                            <img src="{{ url('/public/front') }}/upload/small_03.jpg" alt=""
                                                class="img-fluid float-left">
    ...
    <script src="{{ url('/public/front') }}/js/tether.min.js"></script>
    <script src="{{ url('/public/front') }}/js/bootstrap.min.js"></script>
    <script src="{{ url('/public/front') }}/js/animate.js"></script>
